  ...
  return (
    <div className="absolute inset-0 pointer-events-none flex flex-col items-center justify-center text-white px-8 md:px-16 overflow-hidden">
      ...
      >
        ...
        <p className="mt-4 text-lg md:text-2xl text-gray-300 font-light tracking-wide drop-shadow-md">
          — Creative Developer
        </p>
      </motion.div>
      ...
      <motion.div 
        ...
        className="absolute top-1/2 left-[5%] md:left-[10%] lg:left-[15%] max-w-[600px] -translate-y-1/2"
      >
      ...
      <motion.div 
        ...
        className="absolute top-1/2 right-[5%] md:right-[10%] lg:right-[15%] max-w-[600px] -translate-y-1/2"
      >
